...
LoadingView = function (options) {
  ...
  defaultOption.image = "assets/images/loadingImage.gif"; //You can change this anytime anyday based on your image location.
  defaultOption.imageClassName = "loadingImage";
  defaultOption.imageStyle =
  ...
  var getOption = function (field) {
    return typeof options[field] === "undefined" ||
